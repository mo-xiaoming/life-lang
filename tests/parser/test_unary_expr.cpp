...
inline auto const k_neg_var_expected = test_json::unary_expr("-", test_json::var_name("x"));
...
inline auto const k_pos_var_expected = test_json::unary_expr("+", test_json::var_name("x"));

// Logical NOT tests
constexpr auto k_not_var_should_succeed = true;
constexpr auto k_not_var_input = "!flag";
inline auto const k_not_var_expected = test_json::unary_expr("!", test_json::var_name("flag"));
...
inline auto const k_bitnot_var_expected = test_json::unary_expr("~", test_json::var_name("bits"));
...
TEST_CASE("Parse Unary_Expr", "[parser]") {
  auto const params = GENERATE(
      Catch::Generators::values<Expr_Params>({
          ...
          {"neg variable", k_neg_var_input, k_neg_var_expected, k_neg_var_should_succeed},
          ...
          {"pos variable", k_pos_var_input, k_pos_var_expected, k_pos_var_should_succeed},
          {"logical NOT", k_not_var_input, k_not_var_expected, k_not_var_should_succeed},
          {"double NOT", k_double_not_input, k_double_not_expected, k_double_not_should_succeed},
          {"bitwise NOT", k_bitnot_var_input, k_bitnot_var_expected, k_bitnot_var_should_succeed},
