...
inline auto const k_assignment_with_expr_expected = test_json::assignment_expr(
    ...
    test_json::binary_expr("+", test_json::var_name("y"), test_json::integer(10))
);
...
TEST_CASE("Parse Assignment_Expr", "[parser]") {
  auto const params = GENERATE(
      Catch::Generators::values<Expr_Params>({
          {"simple assignment",
           k_simple_assignment_input,
           k_simple_assignment_expected,
           k_simple_assignment_should_succeed},
          {"assignment with expr",
           k_assignment_with_expr_input,
           k_assignment_with_expr_expected,
           k_assignment_with_expr_should_succeed},
          {"field assignment",
           k_field_assignment_input,
           k_field_assignment_expected,
           k_field_assignment_should_succeed},
          {"nested field assignment",
           k_nested_field_assignment_input,
           k_nested_field_assignment_expected,
           k_nested_field_assignment_should_succeed},
          {"chained assignment",
           k_chained_assignment_input,
           k_chained_assignment_expected,
           k_chained_assignment_should_succeed},
          {"assignment with call",
           k_assignment_with_call_input,
           k_assignment_with_call_expected,
           k_assignment_with_call_should_succeed},
          {"assignment with string",
           k_assignment_with_string_input,
           k_assignment_with_string_expected,
           k_assignment_with_string_should_succeed},
          {"assignment precedence",
           k_assignment_precedence_input,
           k_assignment_precedence_expected,
           k_assignment_precedence_should_succeed},
          {"assignment with comparison",
           k_assignment_with_comparison_input,
           k_assignment_with_comparison_expected,
           k_assignment_with_comparison_should_succeed},
          {"assignment self-reference",
           k_assignment_self_reference_input,
           k_assignment_self_reference_expected,
