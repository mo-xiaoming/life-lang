...
inline auto const k_simple_assignment_expected =
    test_sexp::assignment_statement(test_sexp::var_name("x"), test_sexp::integer(42));

// Assignment with expression
constexpr auto k_assignment_with_expr_should_succeed = true;
constexpr auto k_assignment_with_expr_input = "x = y + 10;";
inline auto const k_assignment_with_expr_expected = test_sexp::assignment_statement(
...
inline auto const k_field_assignment_expected =
    test_sexp::assignment_statement(test_sexp::field_access(test_sexp::var_name("point"), "x"), test_sexp::integer(5));
...
inline auto const k_nested_field_assignment_expected = test_sexp::assignment_statement(
...
inline auto const k_assignment_with_call_expected = test_sexp::assignment_statement(
...
inline auto const k_assignment_with_string_expected =
    test_sexp::assignment_statement(test_sexp::var_name("name"), test_sexp::string(R"("Alice")"));
...
inline auto const k_assignment_precedence_expected = test_sexp::assignment_statement(
    test_sexp::var_name("x"),
...
inline auto const k_assignment_with_comparison_expected = test_sexp::assignment_statement(
...
inline auto const k_assignment_self_reference_expected = test_sexp::assignment_statement(
...
TEST_CASE("Parse Assignment_Statement") {
