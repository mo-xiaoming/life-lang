...
constexpr auto k_empty_string_expected = R"({
  "String": {
    "value": "\"\""
  }
})";
...
constexpr auto k_simple_string_expected = R"({
  "String": {
    "value": "\"hello\""
  }
})";
...
constexpr auto k_with_escaped_quote_expected = R"({
  "String": {
    "value": "\"abc\\\"def\""
  }
})";
...
constexpr auto k_with_newline_escape_expected = R"({
  "String": {
    "value": "\"line1\\nline2\""
  }
})";
...
constexpr auto k_with_hex_escape_expected = R"({
  "String": {
    "value": "\"hex\\x00value\""
  }
})";
...
constexpr auto k_all_escapes_expected = R"({
  "String": {
    "value": "\"abc\\\"d\\n\\x00yz\""
  }
})";
