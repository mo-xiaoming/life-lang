...
using life_lang::ast::Enum_Definition;

PARSE_TEST(Enum_Definition, enum_definition)
...
TEST_CASE("Parse Enum_Definition", "[parser]") {
  auto const params = GENERATE(
      Catch::Generators::values<Enum_Definition_Params>({
