...
inline auto const k_simple_var_name_expected = test_json::var_name("hello");
...
inline auto const k_func_call_expected = test_json::function_call(test_json::var_name("hello"), {});
...
inline auto const k_func_call_with_args_expected = test_json::function_call(
...
inline auto const k_func_call_with_path_args_expected = test_json::function_call(
    test_json::var_name("hello"),
    {test_json::var_name("a"),
     test_json::field_access(test_json::field_access(test_json::var_name("b"), "c"), "world"),
...
inline auto const k_nested_func_calls_expected = test_json::function_call(
    test_json::var_name("hello"),
  ...
  auto const params = GENERATE(
      Catch::Generators::values<Expr_Params>({
          {"simple variable_name",
           k_simple_var_name_input,
           k_simple_var_name_expected,
           k_simple_var_name_should_succeed},
          ...
          {"function call", k_func_call_input, k_func_call_expected, k_func_call_should_succeed},
          {"function call with path",
           k_func_call_with_path_input,
           k_func_call_with_path_expected,
           k_func_call_with_path_should_succeed},
          {"function call with namespace",
           k_func_call_with_namespace_input,
           k_func_call_with_namespace_expected,
           k_func_call_with_namespace_should_succeed},
          {"function call with args",
           k_func_call_with_args_input,
           k_func_call_with_args_expected,
           k_func_call_with_args_should_succeed},
          {"function call with path args",
           k_func_call_with_path_args_input,
           k_func_call_with_path_args_expected,
           k_func_call_with_path_args_should_succeed},
          {"nested function calls",
           k_nested_func_calls_input,
           k_nested_func_calls_expected,
           k_nested_func_calls_should_succeed},
          {"with trailing text",
