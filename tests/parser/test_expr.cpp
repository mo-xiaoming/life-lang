  ...
  auto const params = GENERATE(
      Catch::Generators::values<Expr_Params>({
          {"simple variable_name",
           k_simple_variable_name_input,
           k_simple_variable_name_expected,
          ...
          {"function call with path",
           k_function_call_with_path_input,
           k_function_call_with_path_expected,
           k_function_call_with_path_should_succeed},
          {"function call with namespace",
           k_function_call_with_namespace_input,
           k_function_call_with_namespace_expected,
           k_function_call_with_namespace_should_succeed},
          {"function call with args",
           k_function_call_with_args_input,
           k_function_call_with_args_expected,
           k_function_call_with_args_should_succeed},
          {"function call with path args",
           k_function_call_with_path_args_input,
           k_function_call_with_path_args_expected,
           k_function_call_with_path_args_should_succeed},
          {"nested function calls",
           k_nested_function_calls_input,
           k_nested_function_calls_expected,
